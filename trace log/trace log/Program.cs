...
[assembly: Switch("Wrox.ProCSharp.Instrumentation", typeof(SourceSwitch))]

namespace Wrox.ProCSharp.Instrumentation
{
    public class Program
    {
        internal static SourceSwitch traceSwitch = new SourceSwitch("Wrox.ProCSharp.Instrumentation") {Level = SourceLevels.Verbose};
        internal static TraceSource trace = new TraceSource("Wrox.ProCSharp.Instrumentation"); // { Switch = traceSwitch };
