    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var queryResults =
                ...
                ;
            //method syntax: var queryResults = customers.OrderBy(c => c.Region).ThenBy(c => c.Country).ThenBy(c => c.City).Select(c => new { c.ID, c.Region, c.Country, c.City });
